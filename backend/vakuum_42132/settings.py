"""
Django settings for vakuum_42132 project.
...
ROOT_URLCONF = 'vakuum_42132.urls'
...
WSGI_APPLICATION = 'vakuum_42132.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vakuum_42132 API",
    "DESCRIPTION": "API documentation for vakuum_42132 App",
    "VERSION": "v1",
}
